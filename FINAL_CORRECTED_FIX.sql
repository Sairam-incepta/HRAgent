-- FINAL CORRECTED FIX FOR UNKNOWN EMPLOYEE ISSUE
-- This script includes ALL required columns from the employees table schema

-- 1. Ensure John Smith employee record exists with ALL required fields
